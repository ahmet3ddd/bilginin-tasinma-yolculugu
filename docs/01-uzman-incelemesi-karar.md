# Uzman İncelemesi — Karar Belgesi
## "Aktarım Zinciri / The Transmission Chain" v4.0

Altı bağımsız uzman incelemesi (arkeoloji · bilim ve teknoloji tarihi · nicel modelleme · dijital koruma ve YZ · bilim felsefesi · yayın hazırlığı ve araştırma bütünlüğü). Her incelemeci diğerlerinin bulgularını görmeden çalıştı. Aşağıdaki "yakınsayan bulgular", birbirinden habersiz en az iki incelemecinin bağımsız olarak bulduğu şeylerdir — bu yüzden en yüksek güvenilirliğe sahiptirler.
